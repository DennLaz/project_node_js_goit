 ...
 const [load, setLoad] = useState(false)
  ...
  return (
      ...
      <h2 className={style.text}>
        A confirmation was sent to the <span className={style.text_wrap_email}>{userEmail}</span>, if the email is not received, you can resend it after <span className={style.text_wrap_sec}>{time}</span> seconds:
      </h2>
          <div className={style.btn_wrap}>
              {activeTime ? (
        <Button
          disabled={true}
          className={style.res_btn_dis}
          type="button"
